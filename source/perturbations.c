...
int perturbations_initial_conditions(struct precision * ppr,
  ...
  double fracnu,fracg,fracb,fraccdm,fracdmeff, fracidm_dr = 0.;
  double om;
  ...
  if (_scalars_) {
	...
	/** contributions from interactions with dark matter (dmeff) **/
      if (pba->has_dmeff == _TRUE_){
        ...
        /** - ----> (b.2.b) check whether dmeff tight-coupling approximation should be on */
        if ((tau_dmeff*a_prime_over_a < ppr->tight_coupling_trigger_tau_c_over_tau_h) &&
          (tau_dmeff*k < ppr->tight_coupling_trigger_tau_c_over_tau_k)) {
        
          dy[pv->index_pt_theta_dmeff] =
          - a_prime_over_a*theta_dmeff + metric_euler
          + k2*pvecthermo[pth->index_th_cdmeff2]*y[pv->index_pt_delta_dmeff]
          + (k2*(pvecthermo[pth->index_th_cb2]*delta_b-pvecthermo[pth->index_th_cdmeff2]*y[pv->index_pt_delta_dmeff])+R*(theta_g-theta_b)*pvecthermo[pth->index_th_dkappa])/(1.+R_dmeff+a_prime_over_a/rate_dmeff
          );
        }
	...
	if ((tau_dmeff*a_prime_over_a < ppr->tight_coupling_trigger_tau_c_over_tau_h) &&
          ...
          dy[pv->index_pt_theta_b] +=
           (R*beta_dmeff*(a_prime_over_a-dtau_dmeff/tau_dmeff)*tau_dmeff*(-k2*(pvecthermo[pth->index_th_cb2]*delta_b-pvecthermo[pth->index_th_cdmeff2]*y[pv->index_pt_delta_dmeff])-R*(theta_g-theta_b)*pvecthermo[pth->index_th_dkappa])/(1.+R_dmeff+a_prime_over_a/rate_dmeff)
           + R_dmeff*(-k2*(pvecthermo[pth->index_th_cb2]*delta_b-pvecthermo[pth->index_th_cdmeff2]*y[pv->index_pt_delta_dmeff])-R*(theta_g-theta_b)*pvecthermo[pth->index_th_dkappa])/(1.+R_dmeff+a_prime_over_a/rate_dmeff)
           + R*beta_dmeff*dy[pv->index_pt_theta_dmeff]
           - R*beta_dmeff*metric_euler) / (1.+R+beta_dmeff*R);
        }
          ...
          dy[pv->index_pt_theta_b] +=
           (R*beta_dmeff*(a_prime_over_a-dtau_dmeff/tau_dmeff)*(theta_dmeff-theta_b)
           + R_dmeff/tau_dmeff*(theta_dmeff-theta_b)
           + R*beta_dmeff*dy[pv->index_pt_theta_dmeff]                                                                                            - R*beta_dmeff*metric_euler) / (1.+R+beta_dmeff*R);                                                                                 } 
    ...
    if (ppw->approx[ppw->index_ap_rsa] == (int)rsa_off) {
      ...
      /** - ----> if photon tight-coupling is on: */
        ...
        if (pba->has_dmeff == _TRUE_){
          if ((tau_dmeff*a_prime_over_a < ppr->tight_coupling_trigger_tau_c_over_tau_h) &&
          (tau_dmeff*k < ppr->tight_coupling_trigger_tau_c_over_tau_k)) {
            dy[pv->index_pt_theta_g] += R_dmeff/R * (-k2*(pvecthermo[pth->index_th_cb2]*delta_b-pvecthermo[pth->index_th_cdmeff2]*y[pv->index_pt_delta_dmeff])-R*(theta_g-theta_b)*pvecthermo[pth->index_th_dkappa])/(1.+R_dmeff+a_prime_over_a/rate_dmeff);
          }
          else{
