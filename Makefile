...
# your C compiler:
CC       = /home1/adamhe/.conda/envs/regularised-TCA/bin/x86_64-conda-linux-gnu-gcc
#CC       = icc
#CC       = pgcc
...
OPENBLAS = "-L/home1/adamhe/.conda/envs/TCA/lib"
...
SOURCE = input.o background.o thermodynamics.o perturbations.o primordial.o fourier.o nonlinear_pt.o transfer.o harmonic.o lensing.o distortions.o
...
class: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(CLASS)
	$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) -o class $(addprefix build/,$(notdir $^)) $(OPENBLAS) -lopenblas -lpthread -lm
