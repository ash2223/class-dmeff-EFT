...
cdef class Class:
    ...
    def compute(self, level=["distortions"]):
        ...
        if "input" in level:
            if input_read_from_file(&self.fc, &self.pr, &self.ba, &self.th,
                                    ...
                                    &self.fo, &self.nlpt, &self.le, &self.sd, &self.op, errmsg) == _FAILURE_:
        ...
        if "transfer" in level:
            if transfer_init(&(self.pr), &(self.ba), &(self.th),
                             &(self.pt), &(self.fo), &(self.nlpt), &(self.tr)) == _FAILURE_:
                self.struct_cleanup()
        ...
        if "harmonic" in level:
            if harmonic_init(&(self.pr), &(self.ba), &(self.pt),
                            &(self.pm), &(self.fo), &(self.nlpt), &(self.tr),
                            &(self.hr)) == _FAILURE_:
                self.struct_cleanup()
        ...
        if "lensing" in level:
            if lensing_init(&(self.pr), &(self.pt), &(self.hr),
                            &(self.fo), &(self.nlpt), &(self.le)) == _FAILURE_:
                self.struct_cleanup()
    ...
    def pk(self,double k,double z):
        ...
        result.append(-pk_IFG2+10000000.)
        result.append(-pk_IFG2_0b1+10000000.)
        result.append(-pk_IFG2_0+10000000.)
        result.append(-pk_IFG2_2+10000000.)
        result.append(-pk_CTR+10000000.)
        result.append(-pk_CTR_0+10000000.)
        result.append(-pk_CTR_2+10000000.)
        result.append(-pk_CTR_4+10000000.)
        result.append(pk_Tree-10000000.)
