...
classy_ext = Extension("classy", [os.path.join(classy_folder, "classy.pyx")],
                           ...
                           libraries=liblist,
                           library_dirs=[root_folder, GCCPATH, '/home1/adamhe/.conda/envs/regularised-TCA/lib'],
                           extra_link_args=['/home1/adamhe/.conda/envs/regularised-TCA/lib/libopenblas.so','-lgomp']
                       )
import sys
